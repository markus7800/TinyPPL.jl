...
const VariationalParameters = Union{Vector{Float64}, Tracker.TrackedVector{Float64, Vector{Float64}}, Vector{<:ForwardDiff.Dual}, ReverseDiff.TrackedArray, Vector{Tracker.TrackedReal{Float64}}}
